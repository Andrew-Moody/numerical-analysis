...
void vertex_shader_init(GLuint* shaderId, const char* source)
{
...
void fragment_shader_init(GLuint* shaderId, const char* source)
{
...
void shader_init(GLuint* shader_program_id, const char* vert_shader_source, const char* frag_shader_source)
{
